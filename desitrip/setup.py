...
#
setup_keywords['name'] = 'desitrip'
setup_keywords['description'] = 'DESI transient identification pipeline'
setup_keywords['author'] = 'DESI Collaboration'
setup_keywords['author_email'] = 'desi-timedomain@desi.lbl.gov'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/desihub/timedomain/desitrip'
#
...
#
setup_keywords['package_data'] = {'desitrip': ['data/*', 'test/data/*']}
#
# Run setup command.
#
