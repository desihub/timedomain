...
class fastspecfit(tablebaseclass):
    tablename = "everest.fastspecfit"
    createstatements = [ """
        CREATE TABLE IF NOT EXISTS everest.fastspecfit (  
        ...
        flux_synth_r  REAL,
        flux_synth_z  REAL,
        flux_synth_model_g_2  REAL,
        flux_synth_model_r_2  REAL,
        flux_synth_model_z_2  REAL,
        ...
        continuum_age  REAL,
        continuum_av  REAL,
        continuum_av_ivar_3  REAL,
        dn4000_model_3  REAL,
        flux_synth_model_g_3  REAL,
        flux_synth_model_r_3  REAL,
        flux_synth_model_z_3  REAL,
...
#                 df['survey']=numpy.full(df.shape[0],survey)
                df.columns= df.columns.str.lower()
                try:
                    df.to_sql('fastspecfit',engine,index=False,if_exists='append',schema='everest')
                except:
                    dtypesToSchema(df.dtypes)
                    sys.exit()
