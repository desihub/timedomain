...
# 'cumulative': tids processed if processing one or more nights, 
# 'per_night': tids passed logic processed per night,
# 'per_current_file': files found in glob(current_night),
# 'per_ref_file': files found in glob(ref),
# 'passed_logic': tids passed logic per tile/petal combo found in ref,

count_keep = {'cumulative': 0, 'per_night': 0, 'per_current_file': 0, 'per_ref_file': 0, 'passed_logic': 0}
